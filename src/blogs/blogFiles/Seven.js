        ...
        <div>
            <Grid align="left" style={{backgroundColor:"#eeeeee"}} width="75%">
                <p style={{fontFamily:"Alegreya, serif", color:"#6a6c60", lineHeight:'1.8'}}>
                    ...
                    <i>Ladies and gentlemen, Please read the safety instructions card placed in your seat pocket in front. Fasten your seatbelt by inserting the metal clip into the buckle and tighten it like this. To open lift the buckle. In case of low cabin pressure, oxygen masks will drop automatically from the panel above. Cover your nose and mouth. Please wear your masks first before assisting others. There are 8 emergency exits in this aircraft. 2 forward, 2 rear and 2 over the wings on both sides. Nearest exit can also be behind you. Escape marking system will help to reach nearest helping system. In case of emergency landing, life vests are under the seats.</i><br/><br/>

                    Emergency Exits. Like what will happen, We will be 10000 meters up from the ground and I will be asked to leave?
                    <Twemoji svg text="😳😳"/> I was not told about this. Oxygen mask, why I will need an oxygen mask. Emergency landing in water. OMG, I don’t know how to swim.
                    <Twemoji svg text="😭😭"/> Wasn’t this your duty to make my journey safe?<br/><br/>

                    Nevertheless, I Put my cell phone on flight mode, tray table up , window open. Didn’t have any other option.<br/><br/>
                    ...
                    The passenger next to me had a kid, initially, he only pulled his father’s hair and asked for some toy. But after some time, he started annoying me. He was a real patience-tester. I slept in 15-20 minutes, he started poking me. 2 or 3 times I ignored him, but then I told his father, please take care of your kid.<br/>
                    I don’t really blame the kid for that, if his father has attended to him properly, he could have not annoyed me. When the food came, the kid has spilled everything everywhere and his father did not utter a single word to him. I have booked the window seat, and the kid was all over me when he wanted to look out of the window. One hell out of experience with that kid.
